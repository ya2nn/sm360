const colors = require('tailwindcss/colors'); // Tweak to be able to pair opacity with colors when using CSS variables
...
module.exports = {
  ...
  buttonQuaternaryBorderHover: withOpacityValue('--buttonQuaternaryBorderHover'),
