...
const Accordion = ({
  ...
  }, extraParams), Children.map(children, (child, i) => {
    if (child) {
      return /*#__PURE__*/React.createElement(AccordionItem, {
        ...
        buttonExtraClasses: child.props.buttonExtraClasses ? child.props.buttonExtraClasses : itemsButtonExtraClasses,
        buttonActiveExtraClasses: child.props.buttonActiveExtraClasses ? child.props.buttonActiveExtraClasses : itemsButtonActiveExtraClasses,
        iconExtraClasses: child.props.iconExtraClasses ? child.props.iconExtraClasses : itemsIconExtraClasses,
        iconActiveExtraClasses: child.props.iconActiveExtraClasses ? child.props.iconActiveExtraClasses : itemsIconActiveExtraClasses,
        contentExtraClasses: child.props.contentExtraClasses ? child.props.contentExtraClasses : itemsContentExtraClasses,
        contentContainerExtraClasses: child.props.contentContainerExtraClasses ? child.props.contentContainerExtraClasses : itemsContentContainerExtraClasses
