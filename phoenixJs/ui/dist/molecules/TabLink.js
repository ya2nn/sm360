...
const TabLink = ({
  ...
  const activeClass = `-active bg-primary-white text-primary-black`.concat(extraActiveClasses ? ` ${extraActiveClasses}` : '');
  return /*#__PURE__*/React.createElement("button", _extends({
    className: `m-tabLink flex flex-1 cursor-pointer items-center justify-center p-4 transition-all duration-300 ${extraClasses} ${isActive ? activeClass : ''}`,
    role: "tab",
    tabIndex: tabIndex,
